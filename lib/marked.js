...
(function (global, factory) {
  ...
  var Lexer = /*#__PURE__*/function () {
    function Lexer(options) {
      ...
      this.options = options || exportedValue.defaults;
  ...
  marked.options = marked.setOptions = function (opt) {
    ...
    exportedValue.changeDefaults(marked.defaults);
    return marked;
  };

  marked.getDefaults = exportedValue.getDefaults;
  marked.defaults = exportedValue.defaults;
  /**
   * Expose
   */
